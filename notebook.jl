...
# ╔═╡ 05267104-e51c-11ef-2758-c792eb3347c4
begin
	using DataFrames
	using CSV
end

# ╔═╡ 20277228-100d-40d6-82d8-8aaa57f03af0
using Plots  # This will install plots

# ╔═╡ 8741882c-0e47-4a8e-be13-4e7c55219188
using PlutoUI

# ╔═╡ 69962a16-20ed-4294-9ac3-71527cd6cae9
df = CSV.read("/workspace/Unleashing-Julia-for-the-Fastest-Programming-Language-for-Data-and-AI/WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 575dc249-c1d8-453b-a0d1-d7c7bc1134dc
df.Country_code === df[!, "Country_code"]

# ╔═╡ 87d3ce60-00f0-4fdd-a94c-b0ce3c5d8af4
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ 0365fe9b-80f0-41fc-ae65-2289142593ed
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 49c9494e-fe35-4bef-8cc4-c57939b988be
dates = sg_data[!, "Date_reported"]


# ╔═╡ 0efa4454-b8d3-4080-b633-abc31bd9124e
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ ad717e76-3914-4bfe-9d46-cc9ecc65bf2d
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ 4559f1f4-815a-46cb-9ef2-642cbf256f19
...
# ╔═╡ 5fee4ef4-67fd-41d8-a5b9-b60d4df04279
@bind slider_value Slider(0:10:1000)

# ╔═╡ 6da903f0-5088-41ee-9b2a-767f19d87e98
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 302b2fda-615a-4703-b24d-cf6aac4d4c8e
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ 4b7e2a6f-71fb-4d88-a465-88c46e044f66
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ 9cbda8ee-62da-4161-aec1-4a5dfc417086
